Hide sensitive data from a "masked" user using legacy dynamic masking
===============================================================================

> This page present the **Legacy Dynamic Masking** method that was developed
> in version 1. This method is now replaced by the [Transparent Dynamic Masking]
> method which is better in many ways.
> The **Legacy Dynamic Masking** is still supported in version3 but it will
> be deprecated in version 3.
