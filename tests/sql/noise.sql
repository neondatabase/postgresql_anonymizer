...
SELECT anon.numeric_noise('test_noise','int_value', 0.25);

SELECT anon.numeric_noise('test_noise','float_value', 3);

SELECT datetime_noise('test_noise','date_value', '365 days');
