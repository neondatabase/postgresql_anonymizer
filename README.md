...
SELECT anon.load(); 
SELECT anon.init_masks();

-- STEP 2 : Declare the masking rules
CREATE TABLE people ( id SERIAL, name TEXT, "CreditCard" TEXT);
INSERT INTO people VALUES (1,'Schwarzenegger','1234-1234-1234-1234');
...
-- STEP 3 : Declare a masked users
CREATE ROLE untrusted;
COMMENT ON ROLE unstrusted IS 'MASK';
